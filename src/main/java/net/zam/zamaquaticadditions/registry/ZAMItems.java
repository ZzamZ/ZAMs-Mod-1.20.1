...
public class ZAMItems {
    ...
    //Album Covers
    public static final RegistryObject<Item> POKEMON_ALBUM_CASE = ITEMS.register("pokemon_album_case", () -> new PokemonAlbumCase((new Item.Properties()).stacksTo(1)));
    ...
    public static final RegistryObject<Item> POKEMON_ICIRRUS_CITY = ITEMS.register("pokemon_icirrus_city", () -> new RecordItem(4, ZAMSounds.POKEMON_HUMILAU_CITY, new Item.Properties().rarity(Rarity.RARE).stacksTo(1), 3520));
    public static final RegistryObject<Item> POKEMON_VOLO = ITEMS.register("pokemon_volo", () -> new RecordItem(4, ZAMSounds.POKEMON_NS_CASTLE, new Item.Properties().rarity(Rarity.RARE).stacksTo(1), 5360));

    //Hollow Knight Collection 6
    ...
    public static final RegistryObject<Item> RAPP_SNITHCES = ITEMS.register("rapp_snitches", () -> new RecordItem(4, ZAMSounds.CASTLE_CRASHERS_SPACE_PIRATES, new Item.Properties().rarity(Rarity.RARE).stacksTo(1), 5360));
    ...
    public static final RegistryObject<Item> BRAWL = ITEMS.register("brawl", () -> new RecordItem(4, ZAMSounds.CASTLE_CRASHERS_SPACE_PIRATES, new Item.Properties().rarity(Rarity.RARE).stacksTo(1), 5360));
    public static final RegistryObject<Item> LIFELIGHT = ITEMS.register("lifelight", () -> new RecordItem(4, ZAMSounds.CASTLE_CRASHERS_SPACE_PIRATES, new Item.Properties().rarity(Rarity.RARE).stacksTo(1), 5360));

    //Classical Collection
    public static final RegistryObject<Item> TOCCATA_RECORD = ITEMS.register("tocatta_music_disc", () -> new RecordItem(4, ZAMSounds.TOCCATA, new Item.Properties().rarity(Rarity.RARE).stacksTo(1), 11600));
