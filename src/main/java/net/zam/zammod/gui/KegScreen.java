...
public class KegScreen extends AbstractContainerScreen<KegMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(ZAMMod.MOD_ID, "textures/gui/keg_gui.png");
    private static final ResourceLocation OVERLAY =
            new ResourceLocation(ZAMMod.MOD_ID, "textures/gui/keg_overlay.png");
    private static final ResourceLocation BG =
            new ResourceLocation(ZAMMod.MOD_ID, "textures/gui/dark_bg.png");
    ...
    protected void renderBg(GuiGraphics guiGraphics, float pPartialTick, int pMouseX, int pMouseY) {
        ...
        if (menu.getBeerType() == 1) {
            ...
            RenderSystem.setShaderColor(199f / 255f, 183f / 255f, 1.0f, 1.0f);
        }
