package net.zam.zamaquaticadditions.entity.model;
...
public class KoiModel<T extends Koi> extends EntityModel<T> {
    ...
    public static final ModelLayerLocation LOCATION = new ModelLayerLocation(new ResourceLocation(ZAMAquaticAdditions.MOD_ID, "koi"), "main");
