...
public class BubbleBuddyItem extends Item {

    public BubbleBuddyItem(Properties properties) {
    ...
    void playSound(Player player) {
        player.level().playSound(null, player.blockPosition(), SoundEvents.ELDER_GUARDIAN_AMBIENT, SoundSource.AMBIENT, 1, 1);
    }
