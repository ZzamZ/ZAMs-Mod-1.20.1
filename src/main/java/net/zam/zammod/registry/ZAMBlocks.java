...
import net.zam.zammod.block.BuddingEmeraldBlock;
import net.zam.zammod.block.ModFlammableRotatedPillarBlock;
import net.zam.zammod.block.ScaffinityBlock;
import net.zam.zammod.block.ScaffinityBlockItem;
...
public class ZAMBlocks {
    ...
    public static final RegistryObject<Block> AVOCADO_WOOD = registerBlock("avocado_wood",
            () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.OAK_WOOD).noLootTable()));
    ...
    public static final RegistryObject<Block> STRIPPED_AVOCADO_WOOD = registerBlock("stripped_avocado_wood",
            () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.copy(Blocks.STRIPPED_OAK_WOOD).noLootTable()));
    ...
    public static final RegistryObject<Block> AVOCADO_SAPLING = registerBlock("avocado_sapling",
            () -> new SaplingBlock(null, BlockBehaviour.Properties.copy(Blocks.OAK_SAPLING).noLootTable()));
