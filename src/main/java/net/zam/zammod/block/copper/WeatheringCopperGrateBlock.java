...
public class WeatheringCopperGrateBlock extends CopperGrateBlock implements ZAMOxidizable {
    private final ZAMOxidizable.CopperOxidizableLevel oxidationLevel;

    public WeatheringCopperGrateBlock(ZAMOxidizable.CopperOxidizableLevel oxidationLevel, BlockBehaviour.Properties settings) {
        super(settings);
