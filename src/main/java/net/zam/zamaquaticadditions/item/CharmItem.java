...
public class CharmItem extends Item {
    ...
    protected void addEffectsTooltip(List<MutableComponent> tooltip) {
        tooltip.add(net.minecraft.network.chat.Component.translatable("%s.tooltip.item.%s".formatted(ZAMAquaticAdditions.MOD_ID, getTooltipItemName())));
    }

    protected MutableComponent tooltipLine(String lineId, Object... args) {
        return Component.translatable("%s.tooltip.item.%s.%s".formatted(ZAMAquaticAdditions.MOD_ID, getTooltipItemName(), lineId), args);
    }
